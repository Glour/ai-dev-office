...
function CardAction({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "col-start-2 row-span-2 row-start-1 self-start justify-self-end max-sm:col-start-1 max-sm:row-auto max-sm:row-span-1 max-sm:w-full max-sm:justify-self-stretch",
        className
      )}
      {...props}
    />
